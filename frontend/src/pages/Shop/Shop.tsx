      ...
      >
        ...
        <div className="mx-auto max-w-2xl">
          <div className={`rounded-lg border p-8 shadow-lg ${
            ...
            <h2 className="mb-6 text-center text-2xl font-bold">Full Access Subscription</h2>
            
            <div className="mb-8">
              <div className="mb-6 text-center text-4xl font-bold">$9.99</div>
            ...
            >
              {isAuthenticated ? "Purchase Premium" : "Sign in to Purchase"}
            </button>
          </div>
