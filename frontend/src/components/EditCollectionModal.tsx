...
const EditCollectionModal: React.FC<EditCollectionModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
      ...
      >
        <h1 className="mb-4 text-xl font-bold sm:mb-6 sm:text-2xl">Edit Collection</h1>
        <div className="mb-4 flex flex-col items-center justify-center">
          <label htmlFor="collectionName" className="mb-2 block">Collection Name</label>
          <input
            type="text"
            id="collectionName"
          ...
          {editedItems.map((item, index) => (
            <div key={index} className="mb-4 flex items-center">
              <div className="mr-2 grow">
                <label htmlFor={`item-${index}`} className="mb-1 block">Item {index + 1}</label>
